#Write a program that asks the user to enter the ICAO code of an airport. The program
# fetches and prints out the corresponding airport name and location (town) from the
# airport database used on this course. The ICAO codes are stored in the ident column of
# the airport table.
